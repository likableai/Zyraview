...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-gradient-to-br from-card via-card to-card/95 text-card-foreground border border-border/30 rounded-lg shadow-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:border-border/80 hover:from-card/98 hover:via-card hover:to-card/90",
      className
    )}
    {...props}
  />
