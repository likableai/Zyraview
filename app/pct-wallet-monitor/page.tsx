    ...
    <div className="pct-monitor min-h-screen bg-background text-foreground font-mono selection:bg-primary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28">
        <Tabs value={tab} onValueChange={setTab} className="w-full">
          ...
          <p className="text-sm text-muted-foreground mb-8">{tStr('pct.subtitle')}</p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
            <h2 className="text-lg font-semibold text-primary">
              {tab === 'history' ? tStr('pct.section_history') : tab === 'updates' ? tStr('pct.section_updates') : tStr('pct.section_wallets')}
            </h2>
              ...
              {walletData && walletData.totalPages > 1 && (
                <div className="flex flex-wrap items-center gap-2 px-4 py-3 border-t border-border text-sm">
                  ...
                  <span className="text-muted-foreground text-xs ml-auto">
                    {fmtInt(walletData.total)} {tStr('pct.wallets_index')}
                  </span>
                </div>
              )}
            </div>
            <p className="mt-4 text-center text-xs text-muted-foreground">
              {tStr('pct.footer_note')}
            </p>
          </TabsContent>
